    ...
    <div className="w-full space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {features.map((feature, index) => (
          <div key={index} className="bg-white rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 hover-lift animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
      ...
      {/* Quick Stats */}
      <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg hover-lift animate-fade-in" style={{animationDelay: '0.6s'}}>
        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Quick Overview</h2>
